...
/***/ "./src/js/modules/_layouts/flex/style.scss":
/*!*************************************************!*\
  !*** ./src/js/modules/_layouts/flex/style.scss ***!
  \*************************************************/
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            ...
            injectCss(link, link.href.split("?")[0] + "?unix=1539821905379");
          });
      }
    }
...
/***/ "./src/js/modules/common/btn/style.scss":
/*!**********************************************!*\
  !*** ./src/js/modules/common/btn/style.scss ***!
  \**********************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"btn":"btn___1bgKy","btn--hover":"btn--hover___1BKKv","btn__inner":"btn__inner___1_vF4","btn-wrapper":"btn-wrapper___3jGPx","btn__arrow":"btn__arrow___1pMEU","btn__text":"btn__text___1OR4a","Link__target-blank":"Link__target-blank___2JzxU","btn--arrow":"btn--arrow___yxRYx","btn--small":"btn--small___3WkWr","btn--bordered":"btn--bordered___2kUk1","btn--active":"btn--active___2d5p8","btn--white":"btn--white___1nkIT","btn--dark":"btn--dark___1Xrbn","btn--uppercase":"btn--uppercase___27iH4","btn--danger":"btn--danger___2Nn1L","btn--success":"btn--success___2TtMa","btn--secondary":"btn--secondary___2ryYX"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1539821904784");
          });
      }
    }
...
/***/ "./src/js/modules/common/footer/footer.style.scss":
/*!********************************************************!*\
  !*** ./src/js/modules/common/footer/footer.style.scss ***!
  \********************************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"footer":"footer___3g7EQ","footer__address":"footer__address___2_Dja","footer__title":"footer__title___3xmHY","footer__copyright":"footer__copyright___3NqAK","footer__separeteLine":"footer__separeteLine___sKZ16","footer__social":"footer__social___36-ww","footer__payment":"footer__payment___2lgxI","footer__link":"footer__link___3pMyn","footer__line":"footer__line___1byQC","footer__icon":"footer__icon___1j2Q5","contactFooter":"contactFooter___2yeLW","contactFooter__form":"contactFooter__form___398EC","contactFooter__emails":"contactFooter__emails___x6ZZa","contactFooter__title":"contactFooter__title___2HSQp","contactFooter__text":"contactFooter__text___VNDi5","contactFooter__subtitle":"contactFooter__subtitle___2x0b6","contactFooter__email":"contactFooter__email___1EOdo"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1539821904824");
          });
      }
    }
...
/***/ "./src/js/modules/common/header/views/bnsv1/header.style.scss":
/*!********************************************************************!*\
  !*** ./src/js/modules/common/header/views/bnsv1/header.style.scss ***!
  \********************************************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"breadcrumbs":"breadcrumbs___3YCMa","header":"header___2JlV2","header__submenu":"header__submenu___12Jgv","header__submenuMenu":"header__submenuMenu___2PGY7","isActive":"isActive___3XpR-","header__wrapper":"header__wrapper___2crh0","header__logo":"header__logo___2DHIF","header__separator":"header__separator___1TQHV","header__title":"header__title___rVIm5"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1539821904903");
          });
      }
    }
...
/***/ "./src/js/modules/landings/index/style.scss":
/*!**************************************************!*\
  !*** ./src/js/modules/landings/index/style.scss ***!
  \**************************************************/
/*! no static exports found */
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1539821904471");
          });
      }
    }
...
// extracted by mini-css-extract-plugin
module.exports = {"bnsContainer":"bnsContainer___1UN__","bnsContainer_w720":"bnsContainer_w720___1CRbI","bnsContainer_w860":"bnsContainer_w860___257zn"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1539821896279");
          });
      }
    }
